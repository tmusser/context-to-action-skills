...
3. Wrote [`SPEC.md`](../SPEC.md) to define audience, scope, constraints, acceptance criteria, and verification commands.
4. Wrote [`PLAN.md`](../PLAN.md) to break the work into four vertical slices.
5. Wrote [`TODO.md`](../TODO.md) to track slice status and freeze scope for the next implementation step.
